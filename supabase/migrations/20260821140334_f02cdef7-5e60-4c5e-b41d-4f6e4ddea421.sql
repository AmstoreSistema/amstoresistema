...
BEGIN
    ...
    -- 3. Reverse cashback balance for the client
    ...
    -- The trigger 'transaction_balance_trigger' on 'transactions' will handle 
    -- the automatic account balance reversal when transactions are deleted.
