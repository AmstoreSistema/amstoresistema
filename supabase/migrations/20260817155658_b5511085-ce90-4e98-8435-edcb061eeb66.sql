...
BEGIN
    ...
    -- ONLY insert transaction if it's NOT a debt sale and there is a paid amount.
    -- The transaction trigger 'transaction_balance_trigger' will update the account balance.
