...
BEGIN
    ...
    -- Agora deletamos explicitamente a transação que possui o purchase_id correspondente
    DELETE FROM public.transactions WHERE purchase_id = p_purchase_id;

    -- 3. Deletar a compra (os itens serão deletados via CASCADE se configurado, ou via lógica de banco)
