...
BEGIN
    ...
    -- O gatilho 'transaction_balance_trigger' (AFTER DELETE) agora cuidará 
    -- automaticamente do estorno do saldo na conta financeira.
    ...
    -- mas garantimos a exclusão explícita para evitar erros de FK)
