...
BEGIN
    ...
    LOOP
        ...
        -- Decrementa total e numeração específica se existir
...
BEGIN
    ...
    LOOP
        -- Tenta encontrar o registro de estoque correspondente
        UPDATE public.stock_products
        SET 
    ...
    -- Remover transações associadas ou criar transação de estorno (optamos por marcar a venda)
    -- As transações financeiras poderiam ser excluídas ou estornadas. 
    -- Por simplicidade, deletamos as transações automáticas desta venda.
