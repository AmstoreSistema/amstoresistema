...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "apple-mobile-web-app-title", content: "AmStore" },
    ],
    links: [
      {
        rel: "stylesheet",
      ...
      { rel: "apple-touch-icon", sizes: "192x192", href: "/api/public/pwa-icon?variant=apple-touch" },
      { rel: "apple-touch-icon", sizes: "512x512", href: "/api/public/pwa-icon?variant=512-maskable" },
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Sora:wght@400;500;600;700;800&family=Manrope:wght@400;500;600;700&family=Sacramento&display=swap",
      },
