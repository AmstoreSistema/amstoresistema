...
const BRANDING_META: Record<string, BrandingConfigMeta> = {
  ...
  splash: {
    ...
    maxDimensionNote: "Logo branca sem fundo para a tela splash dourada",
  },
  app_icon: {
    key: "app_icon",
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-6 rounded-3xl border border-gold/40 bg-gradient-to-r from-card via-card/90 to-gold/10 shadow-lg">
        <div className="space-y-1.5">
          ...
          <p className="text-sm text-muted-foreground max-w-2xl">
            Configure e altere todas as imagens da marca do sistema. As alterações são salvas com segurança no
            Storage e refletem imediatamente em todas as páginas, no aplicativo instalado e na tela de login.
          </p>
        </div>
